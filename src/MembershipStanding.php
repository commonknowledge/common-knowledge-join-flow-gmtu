 ...
 *
 * @param string|null $last_paid_month_key 'YYYY-MM' of last paid month, or null if none.
 ...
 *
 * @param string[] $paid_month_keys  Sorted 'YYYY-MM' strings for months with a successful payment.
 * @param string   $as_of_month_key  Current month 'YYYY-MM' (the in-progress month, excluded).
 * @param bool     $is_sticky_lapsed Whether the member has previously been marked as lapsed.
